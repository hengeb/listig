...
│   │       ├── PostAccess.php        # 'members' | 'owners' | 'all'
...
| `post-access` | `members` \| `owners` \| `all` | Who may post (default: `members`) |
...
enum PostAccess: string { case Members = 'members'; case Owners = 'owners'; case All = 'all'; }
...
1. User submits email; server checks LDAP for membership/ownership
...
3. If found: login token generated, link sent (valid 5 min)
